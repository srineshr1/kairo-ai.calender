    ...
    <div className="px-4 py-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex gap-1">
          <button
            className="w-6 h-6 rounded flex items-center justify-center text-gray-500 hover:bg-white/10 hover:text-gray-300 transition-colors"
      ...
      <div className="grid grid-cols-7 gap-0.5">
        {DAY_LABELS.map((l, i) => (
          <div key={i} className="text-center text-[10px] font-medium text-gray-600 uppercase tracking-wide py-1">{l}</div>
        ))}
