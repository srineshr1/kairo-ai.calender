...
export default function EventModal({ isOpen, onClose, editEvent: editTarget, defaultDate, defaultTime }) {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl p-6 w-[400px] shadow-2xl animate-modalIn">
        {showRecurringPrompt ? (
          <>
            <h3 className="text-base font-semibold text-gray-800 mb-2">Edit recurring event</h3>
            <p className="text-sm text-gray-500 mb-5">This is a recurring event. What would you like to edit?</p>
            <div className="flex flex-col gap-2">
              <button onClick={() => handleRecurringChoice(false)}
                className="px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-700 hover:bg-gray-50 transition-colors text-left">
                This event only
              </button>
          ...
          <>
            ...
            <div className="mb-3">
              ...
              <input
                autoFocus
                className="w-full border border-gray-200 rounded-xl px-3 py-2 text-[13.5px] text-gray-800 outline-none focus:border-accent transition-colors font-sans"
            ...
            <div className="flex gap-3 mb-3">
              <div className="flex-1">
                ...
                <input type="date"
                  className="w-full border border-gray-200 rounded-xl px-3 py-2 text-[13px] text-gray-800 outline-none focus:border-accent transition-colors font-sans"
                  value={form.date}
            ...
            <div className="mb-3">
              ...
              <select
                className="w-full border border-gray-200 rounded-xl px-3 py-2 text-[13px] text-gray-700 outline-none focus:border-accent transition-colors bg-white font-sans"
            ...
            <div className="flex items-center gap-2 justify-end">
              ...
              <button
                onClick={onClose}
                className="px-4 py-2 rounded-xl border border-gray-200 text-gray-600 hover:bg-gray-50 text-[13px] transition-colors"
              >
                Cancel
              </button>
              <button
